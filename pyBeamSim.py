...
# use the full path
dll_path = r"D:\desktop\GPU-Accelerated-Beam-Simulation-Algorithm-PKU-main\src\HpsimLib.dll"
dll = cdll.LoadLibrary(dll_path)

# add visit_by_index
""" must make .dll first """
# dll.get_element_index.argtypes = [c_char_p]
# dll.get_element_index.restypes = c_uint
# dll.change_length_by_index.argtypes = [c_uint, c_double]
# dll.get_length_by_index.argtypes = [c_uint]
# dll.get_length_by_index.restypes = c_double
...
class BeamSimulator():
    ...
    # add
    #def get_length_index(self, index):
        #dll.get_length_by_index(index)

    #def change_length_index(self, index, value):
       # dll.change_length_by_index(index, value)
