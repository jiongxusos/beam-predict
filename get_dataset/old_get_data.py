...
for i in range(50000):
    ...
    drift1_length = np.random.uniform(0.1, 0.5)
    drift1_aperture = 0.05
    quad1_length = np.random.uniform(0.1, 0.5)
    quad1_aperture = 0.012
    quad1_field_gradient = np.random.uniform(-20, 20)
    drift2_length = np.random.uniform(0.1, 0.5)
    drift2_aperture = 0.05
    quad2_length = np.random.uniform(0.1, 0.5)
    quad2_aperture = 0.028
    quad2_field_gradient = np.random.uniform(-20, 20)
